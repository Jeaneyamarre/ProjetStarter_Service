...
Public Class GenFunc
    Public Shared Function AffecteData(ByVal NomCol As String, ByVal Reader As SqlDataReader, ByVal TypeCible As String)
        If Not Reader(NomCol) Is Nothing AndAlso Not IsDBNull(Reader(NomCol)) AndAlso Not String.IsNullOrWhiteSpace(Reader(NomCol)) Then
