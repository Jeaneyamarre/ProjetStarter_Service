...
Public Class sql
    ...
    ''' </summary>
    Private objConnex As SqlConnection
    Private objComm As SqlCommand
    Private objCommQuerry As SqlCommand
    Private objDR As SqlDataReader
    Private Nb As Integer

    Private objConnex2 As SqlConnection
    Private objComm2 As SqlCommand
    Private objCommQuerry2 As SqlCommand
    Private objDR2 As SqlDataReader
    Private Nb2 As Integer

    Private objConnex3 As SqlConnection
    Private objComm3 As SqlCommand
    Private objCommQuerry3 As SqlCommand
    Private objDR3 As SqlDataReader
    Private Nb3 As Integer

    Private objConnex4 As SqlConnection
    Private objComm4 As SqlCommand
    Private objCommQuerry4 As SqlCommand
    Private objDR4 As SqlDataReader
    Private Nb4 As Integer

    Private objConnex5 As SqlConnection
    Private objComm5 As SqlCommand
    Private objCommQuerry5 As SqlCommand
    Private objDR5 As SqlDataReader
    Private Nb5 As Integer

    Private p_User As String

    Public Sub New(p_ConnectionString As String, Utilisateur As String)
        Me.ConnectionString = p_ConnectionString
        Me.objConnex = New SqlConnection()
        Me.objConnex2 = New SqlConnection()
        Me.objConnex3 = New SqlConnection()
        Me.objConnex4 = New SqlConnection()
        Me.objConnex5 = New SqlConnection()
        Me.p_User = Utilisateur
    End Sub
...
#Region "Gestion des objets de connexions"
    ...
    Private Sub CheckConnection()
        If Not objConnex.State = ConnectionState.Open Then
            Try
                objConnex = New SqlConnection(ConnectionString)
                objConnex.Open()
    ...
    Private Sub CheckConnection2()
        If Not objConnex2.State = ConnectionState.Open Then
            Try
                objConnex2 = New SqlConnection(ConnectionString)
                objConnex2.Open()
            Catch ex As Exception
    ...
    Private Sub CheckConnection3()
        If Not objConnex3.State = ConnectionState.Open Then
            Try
                objConnex3 = New SqlConnection(ConnectionString)
                objConnex3.Open()
            Catch ex As Exception
    ...
    Private Sub CheckConnection4()
        If Not objConnex4.State = ConnectionState.Open Then
            Try
                objConnex4 = New SqlConnection(ConnectionString)
                objConnex4.Open()
            Catch ex As Exception
    ...
    Private Sub CheckConnection5()
        If Not objConnex5.State = ConnectionState.Open Then
            Try
                objConnex5 = New SqlConnection(ConnectionString)
                objConnex5.Open()
            Catch ex As Exception
    ...
    ''' <returns></returns>
    Public Function RequeteSELECT_Generic(ByVal Requete As String) As SqlDataReader
    ...
    ''' <param name="Requete"></param>
    ''' <returns></returns>
    Public Function RequeteSELECT_Generic(ByVal Requete As String, ByVal ListeParametre As List(Of ParamSQL)) As SqlDataReader
        Dim DataReaderUsed As Integer
        Dim TempDataReader As SqlDataReader
        DataReaderUsed = AssigneFreeDataReader()
        Select Case DataReaderUsed
    ...
    ''' </summary>
    Public Sub CloseSQL()
        If objConnex.State = ConnectionState.Open Then
            objConnex.Close()
        End If
        If objConnex2.State = ConnectionState.Open Then
            objConnex2.Close()
        End If
        If objConnex3.State = ConnectionState.Open Then
            objConnex3.Close()
        End If
        If objConnex4.State = ConnectionState.Open Then
            objConnex4.Close()
        End If
        If objConnex5.State = ConnectionState.Open Then
            objConnex5.Close()
        End If
    End Sub
#End Region
#Region "SQL Reader"
    ...
    ''' <param name="requete"></param>
    ''' <returns></returns>
    Private Function RequeteSELECT(ByVal requete As String) As SqlDataReader
        Try
            Try
                objDR.Close()
            Catch ex As Exception
            End Try
            objComm = New SqlCommand(requete, objConnex)
    ...
    ''' <param name="requete"></param>
    ''' <returns></returns>
    Private Function RequeteSELECT(ByVal requete As String, ByVal ListeParametre As List(Of ParamSQL)) As SqlDataReader
        Try
            Try
                objDR.Close()
            Catch ex As Exception
    ...
    Private Function RequeteSELECT2(ByVal requete As String) As SqlDataReader
        Try
            Try
                objDR2.Close()
            Catch ex As Exception
            End Try
            objComm2 = New SqlCommand(requete, objConnex2)
    ...
    Private Function RequeteSELECT2(ByVal requete As String, ByVal ListeParametre As List(Of ParamSQL)) As SqlDataReader
        Try
            Try
                objDR2.Close()
            Catch ex As Exception
    ...
    Private Function RequeteSELECT3(ByVal requete As String) As SqlDataReader
        Try
            Try
                objDR3.Close()
            Catch ex As Exception
            End Try
            objComm3 = New SqlCommand(requete, objConnex3)
    ...
    Private Function RequeteSELECT4(ByVal requete As String) As SqlDataReader
        Try
            Try
                objDR4.Close()
            Catch ex As Exception
            End Try
            objComm4 = New SqlCommand(requete, objConnex4)
    ...
    Private Function RequeteSELECT3(ByVal requete As String, ByVal ListeParametre As List(Of ParamSQL)) As SqlDataReader
        Try
            Try
                objDR3.Close()
            Catch ex As Exception
        ...
        Return objDR3
    End Function
    Private Function RequeteSELECT4(ByVal requete As String, ByVal ListeParametre As List(Of ParamSQL)) As SqlDataReader
        Try
            Try
                objDR4.Close()
            Catch ex As Exception
        ...
        Return objDR4
    End Function
    Private Function RequeteSELECT5(ByVal requete As String) As SqlDataReader
        Try
            Try
                objDR5.Close()
            Catch ex As Exception
            End Try
            objComm5 = New SqlCommand(requete, objConnex5)
        ...
        Return objDR5
    End Function
    Private Function RequeteSELECT5(ByVal requete As String, ByVal ListeParametre As List(Of ParamSQL)) As SqlDataReader
        Try
            Try
                objDR5.Close()
            Catch ex As Exception
...
#Region "ExecuteNonQuery"
    ...
    Public Sub RequeteINSERTDELETE(ByVal requete As String)
        Try
            ...
            Catch ex As Exception
            End Try
            objCommQuerry = New SqlCommand(requete, objConnex)
...
#Region "Erreur"
    ...
    Public Sub AddErreur(ByVal FunctionCalled As String, ByVal Parameters As String, ByVal Exc As Exception)
        Try
            ...
            LstParamSQL.Add(New ParamSQL("DateErr", Now))
            ...
            requete = "INSERT INTO Erreur(DateErreur, FunctionCalled, ParametersCalled, StackTrace, Message, LoginUser)"
            requete &= " VALUES(@DateErr, @Func, @Params, @Trace, @ErrMsg, @LoginUser)"
