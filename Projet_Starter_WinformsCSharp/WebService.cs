...
using Projet_Starter_WinformsCSharp;
...
public class WebService
{
    ...
    public bool InsertNewDashboard(string statutvalue, int idtache, string valeur)
    {
        bool result = false;
        sql lnk = new sql(ConnectionString);
        List<ParamSQL> Params = new List<ParamSQL>();
